    ...
    <div class="row search_results_row" ng-class="{'result_added' : result.added}" ng-click="add(result, '<?php echo $module_id; ?>')" repeat-done ng-repeat="result in models.<?php echo $module_id; ?>.results">
        ...
        <div ng-class="result.img ? 'col-md-11' : 'col-md-12'">
            ...
            <div class="text-muted" style="padding-top: 5px;">
                ...
                Avg $/sale: <strong class="text-success" ng-show="result.extra.averageDollarsPerSale != '0.00'">${{result.extra.averageDollarsPerSale}}</strong><strong class="text-success" ng-show="result.extra.averageDollarsPerSale == '0.00'">N/A</strong>
