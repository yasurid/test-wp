...
class DaisyconConfig extends AffiliateFeedParserModuleConfig {
    ...
    public function options()
    {
        $optiosn = array(
            ...
            'publisher_id' => array(
                'title' => 'Publisher ID',
                'description' => __('Your Daisycon publisher ID.', 'content-egg') . ' ' . __('Go to SETTINGS -> Account.', 'content-egg') . ' ' . __('It will be used for API authentication.', 'content-egg'),
                'callback' => array($this, 'render_input'),
                'default' => '',
                'validator' => array(
                    'trim',
            ...
            'username' => array(
                'title' => 'Email address',
                'description' => __('Your Daisycon email address.', 'content-egg') . ' ' . __('It will be used for API authentication.', 'content-egg'),
                'callback' => array($this, 'render_input'),
                'default' => '',
                'validator' => array(
                    'trim',
            ...
            'password' => array(
                'title' => 'Password',
                'description' => __('Your Daisycon password.', 'content-egg') . ' ' . __('It will be used for API authentication.', 'content-egg'),
                'callback' => array($this, 'render_input'),
                'default' => '',
                'validator' => array(
                    'trim',
