...
class AffiliatewindowModule extends AffiliateParserModule {
    ...
    public function doRequest($keyword, $query_params = array(), $is_autoupdate = false)
    {
        ...
        $sColumnToReturn = array('bHotPick', 'iUpc', 'iEan', 'sMpn', 'iIsbn', 'sDescription', 'sSpecification', 'sPromotion', 'sBrand', 'sModel', 'sAwImageUrl', 'sMerchantImageUrl', 'sDeliveryTime', 'sCurrency', 'fStorePrice', 'fDeliveryCost', 'sWarranty');
