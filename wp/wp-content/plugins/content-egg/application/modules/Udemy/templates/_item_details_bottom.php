<?php if (!empty($item['extra']['visible_instructors'])): ?>
    <?php foreach ($item['extra']['visible_instructors'] as $instructor): ?>
        <div class="row well well-sm">
            ...
            <div class="col-md-11">
                <?php _e('Created by', 'content-egg-tpl'); ?>:
...
<div class="panel panel-warning">
    <div class="panel-body">
        <?php if (!empty($item['extra']['avg_rating'])): ?>
            <?php _e('Rating:', 'content-egg-tpl'); ?> <?php echo round($item['extra']['avg_rating'], 2); ?> (<?php echo $item['extra']['num_reviews']; ?> <?php _e('reviews', 'content-egg-tpl'); ?>)
            &nbsp;&nbsp;&nbsp;
        <?php endif; ?>
        <?php if (!empty($item['extra']['num_subscribers'])): ?>
            <?php echo $item['extra']['num_subscribers']; ?> <?php _e('students enrolled', 'content-egg-tpl'); ?>
        <?php endif; ?>
