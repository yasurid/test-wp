...
<select class="input-sm col-md-4" ng-model="query_params.<?php echo $module_id; ?>.min_percentage_off">
    <option value=""><?php _e('Min. saving', 'content-egg'); ?></option>
...
<input type="text" class="input-sm col-md-4" ng-model="query_params.Amazon.minimum_price" ng-init="query_params.Amazon.minimum_price = ''" placeholder="<?php _e('Min. price', 'content-egg') ?>" title="<?php _e('Min. price.', 'content-egg') ?>" />
<input type="text" class="input-sm col-md-4" ng-model="query_params.Amazon.maximum_price" ng-init="query_params.Amazon.maximum_price = ''" placeholder="<?php _e('Max. price', 'content-egg') ?>" title="<?php _e('Max. price.', 'content-egg') ?>" />
