    ...
    public function options()
    {
        $optiosn = array(
            ...
            'fid' => array(
                ...
                'description' => __('You can set several Feed IDs with commas', 'content-egg')
                . ' ' . __('You can find list of your feeds <a href="http://api.tradedoubler.com/1.0/productFeeds;pretty=true?token={token}">here</a> (change in URL {token} to your Token).', 'content-egg'),
                'callback' => array($this, 'render_input'),
                'default' => '',
                'validator' => array(
                    'trim',
