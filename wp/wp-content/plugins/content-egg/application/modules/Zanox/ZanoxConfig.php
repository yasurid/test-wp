        ...
        $optiosn = array(
            ...
            'region' => array(
                ...
                'dropdown_options' => array(
                    ...
                    'AD' => 'Andorra', 'AE' => 'United Arab Emirates', 'AG' => 'Antigua and Barbuda', 'AR' => 'Argentina', 'AT' => 'Austria', 'AU' => 'Australia', 'BE' => 'Belgium', 'BG' => 'Bulgaria', 'BH' => 'Bahrain', 'BO' => 'Bolivia', 'BR' => 'Brazil', 'BZ' => 'Belize', 'CA' => 'Canada', 'CH' => 'Switzerland', 'CL' => 'Chile', 'CN' => 'China', 'CO' => 'Colombia', 'CR' => 'Costa Rica', 'CU' => 'Cuba', 'CY' => 'Cyprus', 'CZ' => 'Czech Republic', 'DE' => 'Germany', 'DK' => 'Denmark', 'DO' => 'Dominican Republic', 'EC' => 'Ecuador', 'EE' => 'Estonia', 'EG' => 'Egypt', 'ES' => 'Spain', 'FI' => 'Finland', 'FR' => 'France', 'GB' => 'United Kingdom', 'GF' => 'French Guiana', 'GP' => 'Guadeloupe', 'GR' => 'Greece', 'GT' => 'Guatemala', 'HK' => 'Hong Kong', 'HN' => 'Honduras', 'HR' => 'Croatia', 'HU' => 'Hungary', 'ID' => 'Indonesia', 'IE' => 'Ireland', 'IL' => 'Israel', 'IN' => 'India', 'IS' => 'Iceland', 'IT' => 'Italy', 'JP' => 'Japan', 'KR' => 'Korea, Republic of', 'KW' => 'Kuwait', 'LI' => 'Liechtenstein', 'LT' => 'Lithuania', 'LU' => 'Luxembourg', 'LV' => 'Latvia', 'MC' => 'Monaco', 'MD' => 'Moldova, Republic of', 'MQ' => 'Martinique', 'MT' => 'Malta', 'MX' => 'Mexico', 'MY' => 'Malaysia', 'NI' => 'Nicaragua', 'NL' => 'Netherlands', 'NO' => 'Norway', 'NZ' => 'New Zealand', 'PA' => 'Panama', 'PE' => 'Peru', 'PF' => 'French Polynesia', 'PH' => 'Philippines', 'PL' => 'Poland', 'PM' => 'Saint Pierre and Miquelon', 'PT' => 'Portugal', 'PY' => 'Paraguay', 'QA' => 'Qatar', 'RE' => 'Reunion Réunion', 'RO' => 'Romania', 'RU' => 'Russian Federation', 'RW' => 'Rwanda', 'SA' => 'Saudi Arabia', 'SE' => 'Sweden', 'SG' => 'Singapore', 'SI' => 'Slovenia', 'SK' => 'Slovakia', 'SM' => 'San Marino', 'SV' => 'El Salvador', 'TF' => 'French Southern Territories', 'TH' => 'Thailand', 'TR' => 'Turkey', 'TW' => 'Taiwan, Province of China', 'UA' => 'Ukraine', 'US' => 'United States', 'UY' => 'Uruguay', 'VA' => 'Holy See (Vatican City State)', 'VC' => 'Saint Vincent and the Grenadines', 'VE' => 'Venezuela, Bolivarian Republic of', 'YT' => 'Mayotte', 'ZA' => 'South Africa',
                ),
                'default' => '',
                'section' => 'default',
            ),
