        ...
        <div class="row">
            ...
            <?php foreach ($current_items as $item): ?>
                <div class="col-sm-6 col-md-5 products">
                    ...
                    <?php endif; ?>
                    <br>
                    <a rel="nofollow" target="_blank" href="<?php echo $item['url']; ?>"><?php _e('See all reviews', 'content-egg-tpl'); ?></a>
            ...
            <?php foreach ($current_items as $item): ?>
                <div class="col-sm-6 col-md-5 text-center products">
                    ...
                    <span class="text-muted">
                        <br><?php _e('as of', 'content-egg-tpl'); ?> <?php echo TemplateHelper::getLastUpdateFormatted('Ozon', $post_id); ?>
                    </span>
                </div>
            <?php endforeach; ?>
        </div>     
