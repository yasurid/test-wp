                    ...
                    <?php foreach ($item['extra']['offers'] as $offer): $offer['img'] = 'https://mdata.yandex.net/i?path=b0605194833_img_id6933159904370791674.jpeg'; ?>
                        <div class="row-products">
                            <div class="col-md-2 col-sm-2 col-xs-12 cegg-image-cell">
                                <?php if ($offer['img']): ?>
                                    <a rel="nofollow" target="_blank" href="<?php echo $offer['url']; ?>">
                            ...
                            <div class="col-md-3 col-sm-3 col-xs-12 cegg-btn-cell">
                                <a rel="nofollow" target="_blank" href="<?php echo $offer['url']; ?>" class="btn btn-success"><?php _e('Visit store', 'content-egg-tpl'); ?></a><br>
                            </div>
                        </div>
                    <?php endforeach; ?>
                </div>
