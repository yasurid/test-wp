...
class EbayFinding extends RestClient {
    ...
    public function restGet($path, array $options = null)
    {
        ...
        $output_selector = array(
            'outputSelector' => array('GalleryInfo', 'PictureURLLarge', 'PictureURLSuperSize')
        );
        ...
        $default = array(
            ...
            'REST-PAYLOAD' => '', //	use this parameter to separate the payload part of the URL from the standard headers.
        );
