...
class RH_Install_Theme {
	...
	/*  */
	function themes(){
		return array( '', 'ReMag', 'RePick', 'ReThing', 'ReCash', 'ReDirect', 'ReVendor', 'ReWise', 'ReDokanNew', 'ReMarket', 'ReCompare', 'ReCart', 'ReTour', 'ReDokanNew', 'ReDeal' );
	}
		...
		return array(
			...
			'steps' => array(
				...
				4 => array(
					...
					'description' => esc_html__('It will be visible on Menu panel only on mobiles', 'rehub-framework'),
					'fields' => '<li class="rehub_install_center">
