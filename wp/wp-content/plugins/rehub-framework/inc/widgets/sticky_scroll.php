...
function widget( $args, $instance ) {
	...
	$singleonly = (!empty($instance['singleonly'])) ? $instance['singleonly'] : '';
	...
	function update( $new_instance, $old_instance ) {
		...
		$instance['singleonly'] = ( isset( $new_instance['singleonly'] ) ) ? strip_tags( $new_instance['singleonly'] ) : '';		
	...
	function form( $instance ) {
		...
		$defaults = array( 'title' => '', 'text_code' => '', 'singleonly' => '');		
		...
		<p>
			<label for="<?php echo ''.$this->get_field_id( 'singleonly' ); ?>"><?php esc_html_e('Enable only on inner single pages?', 'rehub-framework'); ?></label>
			<input id="<?php echo ''.$this->get_field_id( 'singleonly' ); ?>" name="<?php echo ''.$this->get_field_name( 'singleonly' ); ?>" value="true" <?php if( $instance['singleonly'] ) echo 'checked="checked"'; ?> type="checkbox" />
		</p>
		<p>
